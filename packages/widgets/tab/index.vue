<template>
  <div class="h3-apps-tab">
    <div class="noscroll-bar" style="width: 100%;overflow:scroll;-webkit-overflow-scrolling:touch;">
    ...
    <!-- <h3-tab-flow  bar-active-color="#108ee9" :line-width="2" :borderBottom="false">
      <h3-tab-item :selected="app[assoKey] === assoKeyValue" 
      v-for="(app, index) in apps" :key="index" @click.native="onClick(index)">
      {{app.DisplayName}}
      </h3-tab-item>
    ...
    <div class="h3-apps-tab-more" @click="onToggle">
      <h3-icon type="same-size-o"></h3-icon>
    </div>
