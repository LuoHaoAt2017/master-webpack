        ...
        <div>
          <h3-swipeout>
            <h3-swipeout-item v-for="(item, index) in itemLists" :key="index"  underlay-color="#F5222D"  transition-mode="follow">
              <div slot="right-menu" >
                <h3-swipeout-button @click.native="clickSwiperoutButton(item)" :width="60" style="background:#F5222D;font-size:0.4rem;">删除</h3-swipeout-button>
              </div>
                ...
                <h3-card-form @click.native="clickCardForm(item)">
                  ...
                  <div> 
                    <div class="title-status"> 
                      ...
                      <h3-status-tip :type="item.status" v-if="item.status"></h3-status-tip>
                    </div>
