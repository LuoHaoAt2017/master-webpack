  ...
  <div class="scroll"
    ...
    >
      <div class="pull-to-refresh-layer" v-if="!!onRefresh">
        <slot name="refresh">
          <div class="preloader">
             <img src="../../styles/img/refresh.png" />
          </div>
      ...
      <slot></slot>
      <div class="infinite-layer" v-if="onInfinite && state !== 2">
        <slot name="infinite">
...
export default {
  ...
  methods: {
    ...
    touchMove(e) {
      ...
      const diffY = e.targetTouches[0].pageY - this.startY;
      const diffX = e.targetTouches[0].pageX - this.startX;
      if (diffX > diffY) {
        return;
      }
      if (diffY > 0) e.preventDefault();
      this.top = (diffY ** 0.8) + (this.state === 2 ? this.offset : 0);
    ...
    mouseMove(e) {
      ...
      this.top = (diff ** 0.8) + (this.state === 2 ? this.offset : 0);
      if (this.state === 2) { // in refreshing
        return;
      }
      if (this.top >= this.offset) {
